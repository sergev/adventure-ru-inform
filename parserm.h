...
[ ParseToken__ given_ttype given_tdata token_n
  ...
  .AssumeDescriptor;
    ...
    if (o == ME1__WD or ME2__WD or ME3__WD or ME4__WD or ME5__WD or ME6__WD or ME7__WD)
        { pronoun_word = o; pronoun_obj = player; }
    #ifnot;
    if (o == ME1__WD or ME2__WD or ME3__WD)
        { pronoun_word = o; pronoun_obj = player; }
    #endif; ! LIBRARY_RUSSIAN
    ...
    if (obj.parse_name~=0) {
        ...
        if (k > 0) {
          ...
          .MMbyPN;
            ...
            ! закомментировано, лучше работает парсер, нужно тестирование
...
[ NounWord i j s;
    ...
    if (i == 0) rfalse;
    #ifdef LIBRARY_RUSSIAN; 
    if (i == ME1__WD or ME2__WD or ME3__WD or ME4__WD or ME5__WD or ME6__WD or ME7__WD) return 1;
    #ifnot;
...
[ AfterGameOver i;
  ...
  .RRQL;
    ...
    #ifdef LIBRARY_RUSSIAN;
    if (i == RESTART__WD or RESTART2__WD) {
    #ifnot;
    if (i == RESTART__WD) {
    #endif; ! LIBRARY_RUSSIAN;
        #Ifdef TARGET_ZCODE;
    ...
    #ifdef LIBRARY_RUSSIAN;
    if (i == RESTORE__WD or RESTORE2__WD) {
    #ifnot;
    if (i == RESTORE__WD) {
    #endif; ! LIBRARY_RUSSIAN;
        RestoreSub();
